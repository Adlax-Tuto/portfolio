	...
	return (
		<Wrapper>
			...
			{desktopMode ? (
				...
				<div className="container mobile-nav-container" id="mobile-nav-container">
					<div className="btn" onClick={closeMobileMenu}>
						<IoIosCloseCircleOutline />
					</div>
					<ul className="list mobile-nav-list">
						<li>
							<a href="#about" data-text="&#x27F4;About" onClick={closeMobileMenu}>
								&#x27F4;About
							</a>
						</li>
						<li>
							<a href="#projects" data-text="&#x27F4;Projects" onClick={closeMobileMenu}>
								&#x27F4;Projects
							</a>
						</li>
						<li>
							<a href="#contact" data-text="&#x27F4;Contact" onClick={closeMobileMenu}>
								&#x27F4;Contact
							</a>
						</li>
