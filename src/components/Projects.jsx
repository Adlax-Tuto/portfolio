	...
	return (
		<Wrapper id="projects">
			<div className="relative-container">
				...
				<div className="secondary-title">some of my work</div>
			</div>
			<div className="projects-container">
				...
				<div className="projects-text-container">
					<p className="projects-text-title">{projects[selectedIndex].title}</p>
					<p className="projects-text-desc">{projects[selectedIndex].desc}</p>
				</div>
			</div>
		</Wrapper>
	);
